...
/* ─── LIST layout (default) ─── */
export function MenuListItem({ item, tenantId, primary, br, cardCls, currencyInfo }: MenuItemProps) {
  return (
...
/* ─── GRID layout ─── */
export function MenuGridItem({ item, tenantId, primary, br, cardCls, currencyInfo }: MenuItemProps) {
  return (
...
/* ─── COMPACT layout ─── */
export function MenuCompactItem({ item, tenantId, primary, currencyInfo }: MenuCompactItemProps) {
  return (
