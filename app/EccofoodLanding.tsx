        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-[0.92fr_1.08fr]">
          <motion.div {...fadeUp()}>
            ...
            <div className="mt-9 flex flex-col gap-3 sm:flex-row">
              ...
              <Link href="/elbuenpaladar/menu" className="inline-flex h-14 items-center justify-center gap-2 rounded-2xl border border-black/10 bg-white px-7 text-sm font-black text-black shadow-sm transition hover:-translate-y-0.5 hover:shadow-xl">
                Ver demo en vivo
              </Link>
            </div>
